...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between p-2 md:mx-6 relative'>
      <NavButton title="Menu" customFunc={() => setActiveMenu((prevActiveMenu) => !prevActiveMenu)} color="teal" icon={<AiOutlineMenu />} />
        ...
        <div className="flex items-center gap-2 cursor-pointer p-1 hover:bg-light-gray rounded-lg" onClick={() => {}}>
          ...
          className="rounded-full w-8 h-8"
           ...
           <p>
             ...
             <span className="text-gray-400 fontt-bold ml-1 text-14">Chinedu</span>
           </p>
           <MdKeyboardArrowDown
